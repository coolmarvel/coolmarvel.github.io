...
export const aiPhilosophy = {
  ...
  intro: [
    ...
    "이 방법론을 Laravel/PHP, FastAPI/Python, Electron/TypeScript, C#/.NET, Fastify/Vite, Tiptap/Spring Boot, Electron/NestJS 등 서로 다른 스택 12개 프로젝트에 일관되게 적용하며, 프로세스 규율 자체를 조직 표준으로 만들었습니다. 언어와 프레임워크가 바뀌어도 하네스의 골격(제약 → 검증 → 기록)은 그대로 이식됩니다.",
...
export const aiPillars: AiPillar[] = [
  ...
  },
  {
    ...
    items: ["ADR 50건 (11개 프로젝트)", "CLAUDE.md 세션 부팅 프로토콜", "writing-guide 문서 표준", "session-log SSOT", "함정 박제"],
  },
  {
...
export const aiMatrix = {
  ...
  rows: [
    ...
    {
      label: "슬래시 커맨드",
      values: ["5종", "3종", "—", "—", "OmD 스킬 22종", "—", "2종", "2종", "2종", "2종 + OmD 스킬 22종", "2종 + OmD 스킬 22종", "2종 + OmD 스킬 22종"],
    },
    {
      label: "MCP",
      values: [
    ...
    {
      label: "디자인 계약",
      values: ["TailAdmin 이식", "—", "—", "v1.7 디자인 토큰(웹 동기화)", "DESIGN.md (Notion + Linear)", "—", "—", "—", "—", "DESIGN.md (Upbit + 업무 도구 실측 색, WPF·Avalonia 토큰 쌍둥이)", "DESIGN.md (Upbit + 상용 웹에디터 픽셀 실측 토큰, 자체 SVG 아이콘 64종)", "DESIGN.md (Core v2 그래프 투영, 카카오톡 PC 창 구조)"],
    },
    {
      label: "ADR",
      values: ["7건", "6건", "—", "2건", "1건 (개정 7회)", "6건", "2건", "2건", "3건", "6건", "6건", "9건"],
    },
    {
      label: "테스트 · UI 자가검증",
      values: [
