          ...
          <div className="portfolio-info-area">
            <div className="portfolio-info">
              ...
              <div className="contents">
                ...
                등록 및 랭킹 구현, emailJs를 활용하여 유저와의 contact 구현,
                개발 단계에서 발생할 이슈 및 에러 해결 위주 담당
                <br />
                <br />
                <br />
          ...
          <div className="portfolio-info-area">
            <div className="portfolio-info">
              ...
              <div className="contents">
                ...
                <br />
                참여 인원 : 4 명 <br />
                담당 업무 : 학원 진도에 맞춰 지식 습득 및 스킬 숙련을 위한
                파트를 나누지 않고 팀원 전체가 MERN(MongoDB, Express, React,
                NodeJS)을 기반으로 만들었습니다.
                <br />
                <br />
